 ...
 *
 * Difficulty 1: Runden auf Zehner/Hunderter (number-input)
 * Difficulty 2: Überschlagsrechnung bei Addition/Subtraktion (multiple-choice)
...
export const template: ExerciseTemplate = {
  ...
  generate(difficulty = 1): Exercise {
    if (difficulty === 1) {
      // Runden auf Zehner oder Hunderter — number-input
    ...
    if (difficulty === 2) {
      // Überschlagsrechnung Addition/Subtraktion — multiple-choice
